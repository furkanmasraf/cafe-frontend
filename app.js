 const backendUrl = "http://localhost:8080";
    ...
    function registerMasaKutusuClicks() {
      document.querySelectorAll('.masa-kutu').forEach(masa => {
        masa.addEventListener('click', () => {
          const masaNo = masa.textContent.trim().split(' ')[1];
          alert(`Masa ${masaNo} seçildi!`);
        });
      });
    }
